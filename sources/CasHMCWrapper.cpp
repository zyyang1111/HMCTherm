...
CasHMCWrapper::CasHMCWrapper(bool withLogic_):
ThermalCal(ThermalCalculator(withLogic_))
{
	//
	...
	hmc = new HMC(debugOut, stateOut, &ThermalCal);
...
{
    //std::cout << "------- currentClockCycle -------- = " << currentClockCycle << " ---------\n";
