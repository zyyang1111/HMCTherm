...
extern long long m2s_loop_iterations;
...
public:
	...
	{
		if (m2s_loop_iterations > 0)
			std::cout << m2s_loop_iterations << " 0x" << std::hex << address << std::dec << " READ\n";
	...
	{
		if (m2s_loop_iterations > 0)
			std::cout << m2s_loop_iterations << " 0x" << std::hex << address << std::dec << " WRITE\n";
	...
	{
		//std::cout << "Init -- (addr: " << std::hex << address << std::dec << ")\n";
